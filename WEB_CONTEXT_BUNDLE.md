...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-193-erd-s-problem-193-be506157-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-193"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-193-erd-s-problem-193-be506157-v1",
      "problem_contract_sha256": "3de1fb72849e848342adc8670a0d461f65fe87c2e1648fc675e803d38d7ef9dd",
      "problem_id": "problem:um-ep-193-erd-s-problem-193-be506157",
      "route_id": "route:um-ep-193-erd-s-problem-193-be506157-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-193-erd-s-problem-193-be506157-source-fidelity-01",
      "graph_id": "graph:um-ep-193-erd-s-problem-193-be506157-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-193-erd-s-problem-193-be506157-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-193-erd-s-problem-193-be506157-root",
          "statement": {
          ...
          "statement_sha256": "2ebe9406e36fc97e83e31f4a198c63b6b15ddd32617bb83683e7479add78e744"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-193-erd-s-problem-193-be506157-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-193-erd-s-problem-193-be506157-root",
      "route_id": "route:um-ep-193-erd-s-problem-193-be506157-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-193-b34f87fb977a",
        "url": "https://www.unsolvedmath.com/problems/EP-193"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
